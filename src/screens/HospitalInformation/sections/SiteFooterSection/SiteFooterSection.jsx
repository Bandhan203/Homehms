...
const contactInfo = [
  ...
  {
    icon: MapPinIcon,
    text: "Healthcare District, Medical Plaza",
  },
];
...
export const SiteFooterSection = () => {
  return (
    <footer className="relative w-full bg-[#0f172a]">
      <div className="relative flex flex-col items-start gap-12 px-8 md:px-12 lg:px-20 pt-16 pb-8 max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 w-full">
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-3">
              <div className="flex w-12 h-12 items-center justify-center rounded-xl bg-[linear-gradient(180deg,rgba(68,199,244,1)_0%,rgba(37,99,235,1)_100%)]">
              ...
              <div className="flex flex-col">
                <div className="[font-family:'Inter',Helvetica] font-bold text-white text-xl leading-7">
                  MediCore
                </div>
        ...
        <div className="flex flex-col md:flex-row w-full pt-8 border-t border-gray-700 items-center justify-between gap-4">
          <div className="[font-family:'Inter',Helvetica] font-normal text-gray-400 text-sm leading-5">
            © Copyright 2025 MediCore. All rights reserved.
          </div>
